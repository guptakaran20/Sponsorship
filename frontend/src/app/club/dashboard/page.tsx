...
import { Calendar, Users, Briefcase, ChevronRight, TrendingUp, Plus, Handshake, Settings } from 'lucide-react';
    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Link href="/club/events/new" className="flex items-center gap-3 bg-slate-900 border border-white/5 rounded-2xl p-4 hover:border-indigo-500/30 hover:bg-indigo-500/5 transition-all group">
                ...
                <Link href="/club/sponsorships" className="flex items-center gap-3 bg-slate-900 border border-white/5 rounded-2xl p-4 hover:border-amber-500/30 hover:bg-amber-500/5 transition-all group">
                    <div className="p-2 bg-amber-500/20 rounded-xl text-amber-400 group-hover:scale-110 transition-transform">
                        <Handshake className="w-5 h-5" />
                    </div>
                    <span className="text-sm font-medium text-white">View Pending Requests</span>
                </Link>
                <Link href="/club/profile" className="flex items-center gap-3 bg-slate-900 border border-white/5 rounded-2xl p-4 hover:border-emerald-500/30 hover:bg-emerald-500/5 transition-all group">
